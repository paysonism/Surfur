...
namespace Bunifu_Browser
{
    public partial class frmBrowser : Form
    {
        ...
        {
            webBrowser1.Navigate("http://pdennsploit.ml/");
        }
        ...
        {
            MessageBox.Show("Feature Coming Soon!","Coming Soon!");
        }
        ...
        private void txtSerachOrUrl_OnIconLeftClick(object sender, EventArgs e)
        {
            txtSerachOrUrl.Clear();
        }

        private void txtSerachOrUrl_DoubleClick(object sender, EventArgs e)
        {
            txtSerachOrUrl.SelectAll();
        }

        private void txtSerachOrUrl_Click(object sender, EventArgs e)
        {
            txtSerachOrUrl.SelectAll();
        }
    }
